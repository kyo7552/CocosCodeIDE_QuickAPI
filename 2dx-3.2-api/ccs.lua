...
--------------------------------------------------------
-- the ccs TInfo
-- @field [parent=#ccs] TInfo#TInfo TInfo preloaded module

--------------------------------------------------------
-- the ccs ObjectFactory
-- @field [parent=#ccs] ObjectFactory#ObjectFactory ObjectFactory preloaded module

--------------------------------------------------------
-- the ccs TriggerObj
-- @field [parent=#ccs] TriggerObj#TriggerObj TriggerObj preloaded module

--------------------------------------------------------
-- the ccs TriggerMng
-- @field [parent=#ccs] TriggerMng#TriggerMng TriggerMng preloaded module

--------------------------------------------------------
-- the ccs MovementEventType
-- @field [parent=#ccs] MovementEventType#MovementEventType MovementEventType preloaded module
